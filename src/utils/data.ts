...
export const dataBooks: Book[] = [
	...
	},
	{
		...
		sinopsis:
			"En este libro, Weiss explora la idea de la reencarnación y el viaje del alma a través de múltiples vidas. A través de sus experiencias con pacientes, el autor presenta casos donde la terapia de regresión ha ayudado a las personas a superar traumas, fobias y problemas emocionales al recordar y procesar experiencias de vidas pasadas.",
	...
	},
	{
		...
		sinopsis:
			'"Como Piensan los Ricos" de Steve Siebold revela los patrones de pensamiento y creencias que distinguen a las personas ricas. A través de entrevistas con millonarios, el autor destaca la importancia del enfoque en oportunidades, la disposición para asumir riesgos y la creencia en el poder del pensamiento positivo. Este libro ofrece una guía para cambiar nuestra mentalidad y adoptar hábitos de pensamiento más alineados con el éxito financiero y profesional.',
	...
	},
	{
		...
		sinopsis:
			"En este libro, Marian Rojas ofrece una guía práctica para atraer cosas buenas en tu vida. A través de ejercicios y técnicas de manifestación, Rojas enseña cómo reprogramar nuestra mente para manifestar deseos específicos y crear una vida más plena y significativa.",
		url: "/books/como-hacer-que-te-pasen-cosas-buenas.pdf",
		portada: `${baseUrl}/qlgbvaf6y3jij4pcqnkp`,
		autor: "Marian Rojas",
		slug: "como-hacer-que-te-pasen-cosas-buenas",
	},
	{
		titulo: "Los secretos de las mentes millonarias",
		sinopsis:
			"En Los secretos de las mentes millonarias, T. Harv Eker revela los patrones de pensamiento y creencias que distinguen a las personas ricas. A través de entrevistas con millonarios, el autor destaca la importancia del enfoque en oportunidades, la disposición para asumir riesgos y la creencia en el poder del pensamiento positivo. Este libro ofrece una guía para cambiar nuestra mentalidad y adoptar hábitos de pensamiento más alineados con el éxito financiero y profesional.",
		url: "/books/los-secretos-de-las-mentes-millonarias.pdf",
		portada: `${baseUrl}/tm9qnhhwj987cmb38cuk`,
		autor: "T. Harv Eker",
		slug: "los-secretos-de-las-mentes-millonarias",
	},
	{
